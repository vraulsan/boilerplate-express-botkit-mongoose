...
function prepareSparkBot (sparkbot) {
    ...
    sparkbot.addMention = function (message, word) {
...
function checkSparkWebhooks (controller) {
...
function loadSparkSkills (file, sparkController) {
    try {
        require("../controllers/spark/" + file)(sparkController);
...
module.exports = {
    prepareSparkBot: prepareSparkBot,
    checkSparkWebhooks: checkSparkWebhooks,
    loadSparkSkills: loadSparkSkills
}
